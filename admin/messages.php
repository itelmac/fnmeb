                      ...
                      $output = '
                        ...
                        <!-- DIRECT REQUEST PRIMARY -->
                            <div class="card card-primary card-outline direct-chat direct-chat-primary">
                              ...
                              <div class="card-body p-0">
                                <ul id="get-users" class="nav nav-pills flex-column">
                                </ul>
                              </div>
                              <!-- /.card-body -->
                            </div>
                        ...
                        <div class="col-md-9">
                            <div class="card card-primary card-outline">
                              ...
                              <form class="inbox-msg-form">
                              <!-- /.card-header -->
                              <div class="card-body">
                                <div class="form-group">
                                  <input class="acctid" type="hidden" value="'.$acctid.'">
                                  <input class="form-control inbox-msg-name" placeholder="Please select an account" value="'.$name.'" readonly required>
                                </div>
                                <div class="form-group">
                                  <input type="text" class="form-control inbox-msg-subject" placeholder="Subject:" required>
                                </div>
                                <div class="form-group">
                                    <textarea class="form-control inbox-msg" rows="4" required>
                                    </textarea>
                                </div>
                              </div>
                              <!-- /.card-body -->
                              <div class="card-footer">
                                <div class="float-right">
                                  <button id="inbox-msg-btn" type="submit" class="btn btn-primary"><i class="far fa-envelope"></i> Send</button>
                                </div>
                              </div>
                              <!-- /.card-footer -->
                              </form>
                        ...
                        <div class="col-md-9">
                          <form class="inbox-msg-form">
                            <div class="card card-primary card-outline">
                              ...
                              <div class="card-body">
                                <div class="form-group">
                                  <input class="form-control inbox-msg-name" placeholder="Please select a user" value="" readonly required>
                                </div>
                                <div class="form-group">
                                  <input type="text" class="form-control inbox-msg-subject" placeholder="Subject:" required>
                                </div>
                                ...
                                <div class="form-group">
                                  <button id="inbox-msg-btn" type="submit" class="btn btn-primary float-right"><i class="far fa-envelope"></i> Send</button>
                                </div>
                              </div>
                              <!-- /.card-body -->
